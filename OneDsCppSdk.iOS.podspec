Pod::Spec.new do |s|
    ...
    s.exclude_files = "lib/android_build/", "lib/bwcontrol/", "lib/http/HttpClient_Android*", "lib/http/HttpClient_Curl.*", "lib/**/*CX.cpp", "lib/http/HttpClient_Win*", "lib/jni", "lib/modules/bondlite", "lib/modules/dataviewer/tests", "lib/modules/examples", "lib/modules/privacy",  "lib/modules/utc/", "lib/modules/exp/examples/", "lib/offline/OfflineStorage_Room.*", "lib/pal/desktop/", "lib/pal/universal/", "lib/pal/posix/*Android.cpp", "lib/pal/posix/sysinfo_utils_mac.*", "lib/pal/posix/NetworkInformationImpl.cpp", "lib/shared/dllmain.cpp", "lib/shared/TimedEvent.cpp", "lib/shared/WindowsDesktopHelpers.cpp", "lib/include/mat/IBandwidthController.hpp", "wrappers/obj-c/main.mm"
